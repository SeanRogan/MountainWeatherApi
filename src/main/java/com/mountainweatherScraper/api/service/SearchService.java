 ...
 * it contains business logic to control the handling of a search query from a call to the /search endpoint. it contains a single methods to format the query and query the database.
 */
@Service
